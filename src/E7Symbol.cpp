...
const uint8_t* E7Symbol::getSmallSymbolGlyph(char c) {
...
const uint8_t* E7Symbol::getMediumSymbolGlyph(char c) {
...
const uint8_t* E7Symbol::getBigSymbolGlyph(char c) {
...
void E7Symbol::convertMediumGlyphTo8x8(const uint8_t* glyph, uint8_t* matrix) {
  matrix[0] = 0;
...
void E7Symbol::convertBigGlyphTo8x8(const uint8_t* glyph, uint8_t* matrix) {
  // переносим верхнюю (8 строк) часть символа в матрицу as is
